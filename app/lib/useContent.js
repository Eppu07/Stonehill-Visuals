...
export const DEFAULT_CONTENT = {
  ...
  about_text_1_en: 'I\'m a 19-year-old photographer from Seinäjoki, freshly graduated from upper secondary school. I\'ve been shooting for two years, and alongside my studies I\'ve spent my free time exploring marketing and the role of social media and visual communication in brand work.',
  about_text_2_en: 'I offer photography, video production and social media services to both businesses and private clients. My photography covers people, businesses, events and products alike. Video production runs the whole process from planning to editing – from short social clips to longer business content.',
